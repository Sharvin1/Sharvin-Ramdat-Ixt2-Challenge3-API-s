...
map.on('load', function() {
		...
		//open brewey ophalen
		//fetch('https://api.openbrewerydb.org/breweries?by_state=ohio') //deze werkt ook
		...
		.then(function(response) {
			...
			var popup = new mapboxgl.Popup()
				.setHTML("<h4>" + breweryData.name + "</h4>" + "Adress: " + breweryData.street + ", " + breweryData.city + "</br>" + "Number: " + breweryData.phone + "</br>" + "E-mail: " + breweryData.website_url)
